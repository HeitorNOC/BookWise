...
INSERT INTO "new_ratings" ("book_id", "created_at", "description", "id", "rate", "user_id") SELECT "book_id", coalesce("created_at", CURRENT_TIMESTAMP) AS "created_at", "description", "id", "rate", "user_id" FROM "ratings";
DROP TABLE "ratings";

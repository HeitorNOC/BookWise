...
INSERT INTO "new_ratings" ("book_id", "created_at", "description", "id", "rate", "user_id") SELECT "book_id", (strftime('%Y-%m-%d %H:%M:%S', 'now')), "description", "id", "rate", "user_id" FROM "ratings";
DROP TABLE "ratings";
